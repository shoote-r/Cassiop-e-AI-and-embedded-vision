...
MODEL_PATH = "mnist_custom.tflite" # Remplacer par le vrai nom de ton fichier
...
while True:
    ...
    # Appliquer un flou pour réduire le bruit vidéo
    blur = cv2.GaussianBlur(gray, (5, 5), 0)
    
    # MODIFICATION 1 : Seuillage Adaptatif (Résiste beaucoup mieux aux ombres que Otsu)
